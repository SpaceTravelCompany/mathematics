...
- **[평면벡터 기초](topics/plane-vectors.html)** : 2차원 벡터의 내적과 기하학적 의미를 먼저 학습한다.
- **[직교성·직교투영·그람-슈미트](topics/orthogonality.html)** : 내적이 0인 벡터들의 관계와 벡터 분해로 확장한다.
- **[SVD](topics/svd.html)** : 특이값 분해는 내적공간의 기하를 행렬분해에 적용한 정점이다.
